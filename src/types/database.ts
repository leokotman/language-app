...
export type UserVocabularyRow = Database['public']['Tables']['user_vocabulary']['Row']
...
export type UserVocabularyInsert = Database['public']['Tables']['user_vocabulary']['Insert']
export type UserVocabularyUpdate = Database['public']['Tables']['user_vocabulary']['Update']
export type UserLanguageInsert = Database['public']['Tables']['user_languages']['Insert']
export type UserLanguageRowUpdate = Database['public']['Tables']['user_languages']['Update']
