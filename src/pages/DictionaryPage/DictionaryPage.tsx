...
export function DictionaryPage() {
  ...
  const appVocabulary = useMemo((): VocabularyRow[] => {
    ...
    const ms =
      typeof performance !== "undefined"
        ...
        : "?";
    dictPerfLog("appVocabulary useMemo ran", {
      ms,
  ...
  useEffect(() => {
    dictPerfLog("effect: lookup debounce scheduled", {
      search,
      delayMs: DEBOUNCE_MS,
    });
    const timeoutId = setTimeout(() => {
      const hasStoreResultsNow = storeResultsLengthRef.current > 0;
      dictPerfLog("effect: lookup debounce fired", {
        search,
        hasStoreResultsNow,
      });
  ...
  return (
    <>
      ...
      <Typography color="text.secondary" sx={{ mt: 1, mb: 2 }}>
        Look up words and add them to your library. Results come from your saved
        words first; when you're online, we can also search the web for more.
      </Typography>
